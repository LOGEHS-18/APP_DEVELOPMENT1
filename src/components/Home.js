  ...
  return (
    ...
    <div className="container1">
      ...
      <div className="content">
        ...
        <div className="right">
          <h2>About Us</h2>
          <p>At FunToys, we're passionate about creating toys that inspire creativity and imagination. Our team of designers and manufacturers work tirelessly to bring you the best toys possible.</p>
          <p>We're committed to using only the safest and highest-quality materials, and we're proud to say that our toys are loved by children all around the world.</p>
        </div>
      </div>
      <div className="links">
